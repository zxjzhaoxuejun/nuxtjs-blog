...
export default {
  async asyncData (cxt) {
    const { total, list } = await getArticleList(cxt, 2)
    return {
      total,
      list
    }
  ...
  data () { return {} },
  head () {
    return this.$seo('HTML5', '关注前端开发技术 ◆ 推动 HTML5 & CSS3 技术发展', [{ hid: 'keywords', name: 'keywords', content: 'CSS3,HTML5,js,前端开发,web' }])
  },
  methods: {
    pageChange (info) {
      // console.log(info)
